...
/*
@@ LUA_COMPAT_FOREACHI defines the functios 'foreach' and 'foreachi' in the table library.
*/
#define LUA_COMPAT_FOREACHI

/*
@@ LUA_COMPAT_MAXN defines the functions 'maxn' and 'getn' in the table library.
*/
#define LUA_COMPAT_MAXN
